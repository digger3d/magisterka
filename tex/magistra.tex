...
\includegraphics[scale=0.25]{grafika/klastry_unlabeled}
\end{figure}
...
\includegraphics[scale=0.25]{grafika/klastry_pca_nieopisane}
\end{figure}
...
\label{pca_opisane}
\includegraphics[scale=0.25]{grafika/klastry_pca}
\end{figure}
...
\includegraphics[scale=0.25]{grafika/k_means_20_accord}
\end{figure}

\begin{figure}
\caption{Korygowany Współczynnik Przekrywania dla algorytmu K-Means, 20 iteracji.}
\label{rysKMeansNeigh}
\includegraphics[scale=0.25]{grafika/k_means_20_neigh}
\end{figure}
